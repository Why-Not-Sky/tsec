...
class Crawler():
    ...
    def get_data_all(self, start_date='20160701', end_date='20160715'):
        ...
        error_times = 0
        # back to download
        first_day = str_to_date(end_date)
        last_day = str_to_date(start_date)
...
def main():
    ...
    if len(args.day) == 0:
        ...
        first_day = str_to_date(str(args.day[0]))
    else:
    ...
    if args.back or args.check:
        ...
        last_day = str_to_date(str(args.day[1])) if args.back else first_day - timedelta(10)
    else:
        last_day = first_day

    crawler = Crawler()
    crawler.get_data_all(last_day, first_day)
